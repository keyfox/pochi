              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (this.options.tokenize)
                    for (var r = e.split(this.options.tokenSeparator), n = 0, o = r.length; n < o; n += 1)
                ...
                value: function () {
                  ...
                  for (var s = {}, c = 0, h = r.length; c < h; c += 1)
                    for (var l = r[c], u = 0, f = this.options.keys.length; u < f; u += 1) {
                      ...
                      if ("string" != typeof d) {
                        if (((s[d.name] = { weight: 1 - d.weight || 1 }), d.weight <= 0 || 1 < d.weight))
                ...
                value: function (e, t) {
                  ...
                  if (null != i) {
                    ...
                    if ("string" == typeof i) {
                      ...
                      var k = u.search(i);
                      if (
                        (this._log('Full text: "'.concat(i, '", score: ').concat(k.score)),
                        this.options.tokenize)
                      ) {
                        for (
                          var S = i.split(this.options.tokenSeparator), x = [], b = 0;
                          b < h.length;
                          b += 1
                        ) {
                          var M = h[b];
                          ...
                          for (var _ = !1, L = 0; L < S.length; L += 1) {
                            var w = S[L],
                              ...
                              C = {};
                            A.isMatch
                              ? ((C[w] = A.score), (_ = g = !0), x.push(A.score))
                              : ((C[w] = 1), this.options.matchAllTokens || x.push(1)),
                              this._log('Token: "'.concat(w, '", score: ').concat(C[w]));
                          }
                          _ && (m += 1);
                        }
                        y = x[0];
                      ...
                      var j = k.score;
                      -1 < y && (j = (j + y) / 2), this._log("Score average:", j);
                      ...
                      if ((this._log("\nCheck Matches: ".concat(P)), (g || k.isMatch) && P)) {
                        ...
                        F
                          ...
                          : ((d[s] = {
                              item: a,
                              output: [
                                { key: r, arrayIndex: o, value: i, score: j, matchedIndices: k.matchedIndices },
                              ],
                            }),
                            p.push(d[s]));
                      }
                      ...
                      for (var T = 0, z = i.length; T < z; T += 1)
                        this._analyze(
                          { key: r, arrayIndex: T, value: i[T], record: a, index: s },
                          { resultMap: d, results: p, tokenSearchers: h, fullSearcher: u }
                        );
                  }
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  for (var o = 0, i = e.length; o < i; o += 1) {
                    var a = e[o];
                    if (
                      (this.options.id && (a.item = this.options.getFn(a.item, this.options.id)[0]), n.length)
                    ) {
                      for (var s = { item: a.item }, c = 0, h = n.length; c < h; c += 1) n[c](a, s);
                      t.push(s);
                    } else t.push(a.item);
                  }
                  return t;
      ...
      function (e, t, r) {
        ...
        e.exports = function (e, t, r, n) {
          ...
          for (var M = [], _ = 1, L = m + p, w = 1 << (m - 1), A = 0; A < m; A += 1) {
            for (var C = 0, I = L; C < I; )
              E(t, { errors: A, currentLocation: v + I, expectedLocation: v, distance: s }) <= g
                ? (C = I)
                : (L = I),
            ...
            for (var F = j; O <= F; F -= 1) {
              ...
              if (
                ...
                P[F] & w &&
                  (_ = E(t, { errors: A, currentLocation: T, expectedLocation: v, distance: s })) <= g)
              ) {
                if (((g = _), (y = T) <= v)) break;
                O = Math.max(1, 2 * v - y);
              }
          ...
          return { isMatch: 0 <= y, score: 0 === _ ? 0.001 : _, matchedIndices: K(k, d) };
        };
      },
      function (e, t) {
        e.exports = function (e, t) {
            ...
            if (r) {
              ...
              if (null != s)
                if (a || ("string" != typeof s && "number" != typeof s))
                  if (l(s)) for (var c = 0, h = s.length; c < h; c += 1) e(s[c], a, n);
                  else a && e(s, a, n);
